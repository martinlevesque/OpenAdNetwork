...
<tr>
	...
	<td>
		<a href="edit-website-publisher.php?id=<?= $websites[$i]["id"] ?>">Edit</a> 

		<? if ($websites[$i]["nb_zones_active"] == 0) { ?>
			| <a onclick="return confirm('Are you sure ?');" href="delete-website-publisher.php?id=<?= $websites[$i]["id"] ?>">Delete</a>
		<? } ?>

		| <a href="add-zone-publisher.php?website_id=<?= $websites[$i]["id"] ?>">Add a zone</a>
	</td>
</tr>
