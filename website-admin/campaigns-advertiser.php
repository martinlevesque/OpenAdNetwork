...
<br /><br />
<table border="1">
<tr><th>Name</th><th>Category</th><th>Limit per day</th><th>Status</th><th>Today's clicks</th><th>Points spent</th><th>Actions</th></tr>
...
<tr>
	...
	<td><?= $campaigns[$i]["max_per_day"] ?> points</td>
	<td>Paused: <?= intval($campaigns[$i]["paused"]) == 1 ? "Yes" : "No" ?><br />
		A: <b><?= $campaigns[$i]["status"] ?></b><?= ($campaigns[$i]["status_comment"] != "") ? ", comment: " . $campaigns[$i]["status_comment"] : ""  ?>
	</td>
	<td><?= $campaigns[$i]["nb_clicks"] ?></td>
	<td><?= $campaigns[$i]["costs"] ?></td>
	<td>
