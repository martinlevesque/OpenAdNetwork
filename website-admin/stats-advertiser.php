...
$campaign = isset($_POST["campaign_id"]) ? $_POST["campaign_id"] : "";
...
<tr>
<th>Date</th><th>Campaign</th><th>Format</th><th>Views</th><th>Clicks</th><th>iPoints spent</th>
</tr>
<?
...
<tr>
<td><?= $stats[$i]["created_on"] ?></td><td><?= $stats[$i]["campaign_name"] ?></td><td><?= $stats[$i]["banner_name"] ?> #<?= $stats[$i]["campaign_banner_id"] ?></td><td><?= $stats[$i]["nb_views"] ?></td><td><?= $stats[$i]["nb_clicks"] ?></td><td><?= round(floatval($stats[$i]["costs"]), 1) ?></td>
</tr>

<?
	$sumViews += intval($stats[$i]["nb_views"]);
	$sumClicks += intval($stats[$i]["nb_clicks"]);
	$sumCosts += round(floatval($stats[$i]["costs"]), 1);
}
?>
<tr><td><b>----------</b></td><td><b>----------</b></td><td><b>----------</b></td><td><b>----------</b></td><td><b>----------</b></td><td><b>----------</b></td></tr>
<tr><td><b>Total</b></td><td></td><td></td><td><b><?= $sumViews ?></b></td><td><b><?= $sumClicks ?></b></td><td><b><?= $sumCosts ?></b></td></tr>
